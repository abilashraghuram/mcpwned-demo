...
export class BamlAsyncClient {
  ...
  async GeneratePlaygroundDiagramMock(
      rawToolsInput: PlaygroundToolsInput,
      __baml_options__?: BamlCallOptions
  ): Promise<PlaygroundDiagramMock> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const raw = await this.runtime.callFunction(
      ...
      return raw.parsed(false) as PlaygroundDiagramMock
    } catch (error) {
      throw toBamlError(error);
    }
  }
  
  async GenerateSingleRule(
    ...
    try {
      ...
      return raw.parsed(false) as RuleList
    } catch (error) {
      throw toBamlError(error);
    }
  }
...
class BamlStreamClient {
  ...
  GeneratePlaygroundDiagramMock(
      rawToolsInput: PlaygroundToolsInput,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, collector?: Collector | Collector[] }
  ): BamlStream<partial_types.PlaygroundDiagramMock, PlaygroundDiagramMock> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const raw = this.runtime.streamFunction(
      ...
      return new BamlStream<partial_types.PlaygroundDiagramMock, PlaygroundDiagramMock>(
        raw,
  ...
  GenerateSingleRule(
      rawToolsInput: RuleInput,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, collector?: Collector | Collector[] }
  ): BamlStream<partial_types.RuleList, RuleList> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const raw = this.runtime.streamFunction(
      ...
      return new BamlStream<partial_types.RuleList, RuleList>(
        raw,
        (a): partial_types.RuleList => a,
        (a): RuleList => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
