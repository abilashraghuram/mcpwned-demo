    ...
    <DashboardShell>
      <div className="w-full px-8 py-8">
        <header className="flex flex-col md:flex-row items-center justify-center py-8 mb-8 border-b border-muted/40 gap-8 md:gap-16">
          ...
          <form onSubmit={handleWaitlistSubmit} className="bounce-y mt-6 md:mt-0 w-full max-w-md bg-black/90 border-2 border-primary rounded-xl p-8 flex flex-col items-center gap-3 shadow-2xl transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
